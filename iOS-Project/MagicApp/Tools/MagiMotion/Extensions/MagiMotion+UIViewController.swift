//
//  MagiMotion+UIViewController.swift
//  MagicApp
//
...
fileprivate struct AssociatedInstance {
    ...
    var modalTransitionType: MagiMotionTransitionAnimationType
    
    /// A reference to the navigation animation.
    var navigationTransitionType: MagiMotionTransitionAnimationType
    
    /// A reference to the tabBar animation.
    var tabBarTransitionType: MagiMotionTransitionAnimationType
...
extension UIViewController {
    ...
    public var motionTransitionType: MagiMotionTransitionAnimationType {
        get {
    ...
    public var isMotionEnabled: Bool {
        get {
            return transitioningDelegate is MagiMotionTransition
        }
        set(value) {
            ...
            if value {
                transitioningDelegate = MagiMotionTransition.shared
                
                if let v = self as? UINavigationController {
                    previousNavigationDelegate = v.delegate
                    v.delegate = MagiMotionTransition.shared
                }
                ...
                if let v = self as? UINavigationController, v.delegate is MagiMotionTransition {
                    v.delegate = previousNavigationDelegate
                }
                
                if let v = self as? UITabBarController, v.delegate is MagiMotionTransition {
...
extension UINavigationController {
    ...
    public var motionNavigationTransitionType: MagiMotionTransitionAnimationType {
        get {
...
extension UITabBarController {
    ...
    public var motionTabBarTransitionType: MagiMotionTransitionAnimationType {
        get {
...
extension UIViewController {
    ...
    public func motionUnwindToViewController(withMatchBlock: (UIViewController) -> Bool) {
        ...
        if t.presentedViewController != fvc {
            ...
            MagiMotionTransition.shared.fromViewController = fvc
    ...
    public func motionReplaceViewController(with next: UIViewController) {
        let motion = next.transitioningDelegate as? MagiMotionTransition ?? MagiMotionTransition.shared
